...
export class CreateKitchenQuoteDto {
    ...
    @Transform(({ value }) => toBoolean(value)) @IsBoolean() @IsOptional() installNewInsulationRThirteen?: boolean | null;
    @IsString() @IsOptional() installNewInsulationRThirteenQuantity?: string;
    ...
    @IsOptional() basicupperCabinetsThirtySix?: number | null;
    @IsOptional() basicupperCabinetsFortyTwo?: number | null;
    ...
    @IsOptional() premiumupperCabinetThirty?: number | null;
    @IsOptional() premiumupperCabinetsThirtySix?: number | null;
    @IsOptional() premiumupperCabinetsFortyTwo?: number | null;
    ...
    @IsOptional() luxuryupperCabinetThirty?: number | null;
    @IsOptional() luxuryupperCabinetsThirtySix?: number | null;
    @IsOptional() luxuryupperCabinetsFortyTwo?: number | null;
    ...
    @IsString() @IsOptional() basicupperCabinetsThirtySixQuantity?: string;
    @IsString() @IsOptional() basicupperCabinetsFortyTwoQuantity?: string;
    @IsString() @IsOptional() basicBaseCabinetQuantity?: string;
    @IsString() @IsOptional() basicTallCabinetsQuantity?: string;
    @IsString() @IsOptional() premiumupperCabinetThirtyQuantity?: string;
    @IsString() @IsOptional() premiumupperCabinetsThirtySixQuantity?: string;
    @IsString() @IsOptional() premiumupperCabinetsFortyTwoQuantity?: string;
    @IsString() @IsOptional() premiumBaseCabinetQuantity?: string;
    @IsString() @IsOptional() premiumTallCabinetsQuantity?: string;
    @IsString() @IsOptional() luxuryupperCabinetThirtyQuantity?: string;
    @IsString() @IsOptional() luxuryupperCabinetsThirtySixQuantity?: string;
    @IsString() @IsOptional() luxuryupperCabinetsFortyTwoQuantity?: string;
